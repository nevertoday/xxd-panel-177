...
# XXD Panel 177｜جزيرة مصغرة بطباعة خطية وحدود غير منتظمة
...
جزيرة مصغرة بطباعة خطية وحدود غير منتظمة
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-177`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-177 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-177-prompt.en.md) أو [بالصينية](references/xxd-panel-177-prompt.zh-CN.md).
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 177 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
