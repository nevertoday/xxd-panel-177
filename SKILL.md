---
name: xxd-panel-177
description: "Create Panel 177 raster artwork: Irregular Silhouette Woodcut Micro-island. Use when the user invokes xxd-panel-177 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-177/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-177-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
